    ...
    <div class="container">
        ...
        <div class="cart-wrapper-area py-3">
            <div class="card cart-amount-area">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h6>Win Rate:- {{$user->admin_cut_jodi}}X </h6>
                    <h6>Min Bet Amount:- {{$betPrice['jodiGame']}} </h6>
                </div>
                    ...
                    <form action="{{ route('optionGameEntry') }}" method="POST">
                        ...
                        <div class="input-group row">
                            ...
                            <div class="col-md-6 col-6">
                                ...
                                <input type="text" name="adminshare" value="{{ $parentDetails->admin_cut_jodi }}" hidden>
                                <input type="text" name="subadminshare" value="{{ $parentDetails->user_cut_jodi }}" hidden>
                                <input type="text" name="adminrate" value="{{ $user->admin_cut_jodi }}" hidden>
                                <input type="text" name="subadminrate" value="{{ $user->user_cut_jodi }}" hidden>
            ...
            <div class="cart-table card mb-3">
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $bid->bid_amount*$user->admin_cut_jodi }}</td>
                                <th scope="row">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    ...
                    <form action="{{ route('submitAllBid') }}" method="POST" id="submitAllBid">
                        ...
                        <input type="text" name="admin_cut" value="{{ $user->admin_cut_jodi}}" hidden>
                        <input type="text" name="subadmin_cut" value="{{ $user->user_cut_jodi}}" hidden>
